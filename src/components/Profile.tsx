      ...
      <div className="flex-col justify-start items-start gap-2 inline-flex">
        <div className="justify-start items-center gap-[248px] inline-flex">
          <div className="justify-start items-start gap-1 flex">
            <div className="w-8 h-8 px-[6.27px] py-1.5 bg-zinc-100 rounded-lg border border-stone-300 justify-center items-center flex">
              <div className="w-[19.45px] h-5 relative flex-col justify-start items-start flex" />
            </div>
            <div className="w-8 h-8 p-[7px] bg-zinc-100 rounded-lg border border-stone-300 justify-center items-center flex">
